...
%       'RT60', 0.5, 'PlotResults', true);
    ...
    src1_pos = [array_center(1) + source_distance * sind(theta_target), ...
                array_center(2) + source_distance * cosd(theta_target), ...
                1.5];
    
    src2_pos = [array_center(1) + source_distance * sind(theta_interf), ...
                array_center(2) + source_distance * cosd(theta_interf), ...
                1.5];
