...
% Output
cfg.output_dir = '.'; % default: current folder
cfg.save_clean_reference = true; % saves first-mic target as clean ref
cfg.save_metadata_mat = true;
